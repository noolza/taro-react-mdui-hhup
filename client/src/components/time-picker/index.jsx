...
export default class TimePicker extends Component {
  ...
  changeHandel = (e) => {
    ...
    console.log(selectIndexList.length)
    // 更新年、天数
        ...
        <View className='selector-wrap'>
          ...
          </View>
          {
            current && <View className='clear-icon'>
              <View className='mdui-icon material-icons' onClick={this.clear}>highlight_off</View>
            </View>
          }
        </View>
        {visible
          ...
          <View className='model-box'>
            <View className='model-picker'>
              ...
              <View className='cont_model'>
                <PickerView className='pick-view' indicatorStyle='height: 50px;' value={selectIndexList} onChange={this.changeHandel.bind(this)}>
                  {/*年*/}
