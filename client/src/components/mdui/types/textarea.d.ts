...
export interface MdTextareaProps extends MdBaseProps {
  /**
  ...
  onClick?: (value: string, event?: CommonEvent) => void
  /**
...
export interface MdTextareaState {
  focus:boolean,
  row:number,
  inputValue:string
}

declare const MdTextarea: ComponentClass<MdTextareaProps,MdTextareaState>
